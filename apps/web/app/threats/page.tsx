...
export const metadata: Metadata = {
  ...
  description:
    "One swapped artifact and your agent leaks data, runs the wrong tool, or worse — and nothing in your logs would show it. Aegis verifies before it runs.",
};

const TIMELINE = [
  {
    dot: "#a8a29e",
    title: "Trusted package installed",
    sub: "verified by no one",
    accent: false,
  },
  {
    dot: "#fbbf24",
    title: "Dependency silently swaps it",
    sub: "hash changes, no alert",
    accent: false,
  },
  {
    dot: "#f87171",
    title: "Agent executes the poison",
    ...
    <div>
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[1.1fr_.9fr]">
          <div>
            ...
            <h1 className="font-display text-5xl font-semibold leading-[1.04] tracking-[-0.025em] sm:text-6xl">
              Your agent just ran code it didn&apos;t write.
            </h1>
            <p className="mt-5 max-w-md text-lg leading-relaxed text-[#d6d3ce]">
              One swapped file and your agent leaks data, runs the wrong tool, or worse — and
      ...
      <section id="fix" className="mx-auto max-w-6xl scroll-mt-24 px-6 py-20 text-center">
        ...
        <h2 className="font-display text-4xl font-semibold tracking-[-0.02em] sm:text-5xl">
          Don&apos;t trust code. Verify it.
        </h2>
        <p className="mx-auto mt-4 max-w-xl text-lg leading-relaxed text-[#57534e]">
          Aegis fingerprints every artifact, signs it on a Ledger device, anchors it with a
          Chainlink CRE workflow, and names it on ENS. The verifier checks before it runs.
        </p>
        ...
        <div className="mx-auto mt-11 grid max-w-3xl gap-4 text-left sm:grid-cols-2">
          <div className="rounded-xl border border-[#f1c9c9] bg-[#fef5f5] p-6">
            ...
            <p className="text-[15px] leading-relaxed text-[#9f5050]">
              Code runs on blind trust. Tampering is invisible. No proof of what executed.
            </p>
          </div>
          <div className="rounded-xl border border-[#b7e3cd] bg-[#f3fbf7] p-6">
            ...
            <p className="text-[15px] leading-relaxed text-[#3f7a5f]">
              Every run checks hash vs. on-chain record. Tampered artifacts are blocked. Full audit
              trail.
            </p>
          </div>
        </div>
        ...
        <div className="mt-12 flex flex-wrap items-center justify-center gap-3 text-[15px] text-[#57534e]">
          ...
          <span className="rounded-full border border-[#e7e5e1] px-4 py-2">Ledger sign</span>
          <span className="text-[#d6d3ce]">→</span>
          <span className="rounded-full border border-[#e7e5e1] px-4 py-2">Chainlink CRE</span>
          <span className="text-[#d6d3ce]">→</span>
